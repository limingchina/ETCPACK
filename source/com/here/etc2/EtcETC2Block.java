...
public class EtcETC2Block {
    ...
    public static void compressBlockETC2Fast(byte[] img, byte[] alphaimg, byte[] imgdec, int width, int height, int startx, int starty, int[] compressed1, int[] compressed2) {
        int block_part1 = 0;
        int block_part2 = 0;
        int i, j;
